...
export default function DiscQueue(props) {
                                    ...
                                    <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr key={person.profile_id} className={personIdx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{person.name} {person.last_name}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{person.compatibility_score}</td>
